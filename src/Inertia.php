 ...
 * @method static void share(string|array|\Illuminate\Contracts\Support\Arrayable $key, mixed|null $value = null)
 * @method static mixed getShared(string|null $key = null, mixed|null $default = null)
